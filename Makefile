...
.PHONY: lint lint-only test-harnesses shellcheck markdownlint jsonlint actionlint agent-lint agnix gitleaks trufflehog setup test-redact test-validate-research-output test-validate-citations test-collect-reviewer-bash32 test-parse-input test-allocate-candidates test-add-blocked-by test-parse-args test-prepare-description test-parse-prose-blockers test-issue-lifecycle test-fix-issue-bail-detection test-fix-issue-step-order test-find-lock-issue test-sentinel-write test-sessionstart test-audit-edit-write test-block-submodule test-deny-edit-write test-post-scaffold-hints test-render-skill test-render-lane-status test-render-deep-lane-status test-verify-skill-called test-check-bump-version test-lint-skill-invocations test-anti-halt test-orchestrator-scope-sync test-alias-target-resolution test-alias-structure test-design-structure test-implement-rebase-macro test-implement-structure test-quick-mode-docs-sync test-references-headers test-render-reviewer-prompt test-research-structure test-research-adjudication test-review-structure test-run-research-planner test-classify-research-scale test-render-findings-batch test-degraded-path-banner test-synthesis-subagent test-quick-vote-state test-standard-angle-prompts test-subskill-anchors test-loop-improve-skill-driver test-loop-improve-skill-skill-md test-loop-review-driver test-loop-review-skill-md test-loop-fix-issue-driver test-loop-fix-issue-skill-md test-improve-skill-iteration test-improve-skill-skill-md test-parse-skill-judge-grade test-lib-halt-ledger test-tracking-issue-write test-tracking-issue-read-sentinel test-assemble-anchor test-token-tally test-umbrella-helpers test-umbrella-parse-args smoke-dialectic halt-rate-probe eval-research test-eval-set-structure test-eval-research-baseline-flag
...
test-collect-reviewer-bash32:
	bash scripts/test-collect-reviewer-bash32.sh
...
test-loop-fix-issue-driver:
	bash scripts/test-loop-fix-issue-driver.sh

test-loop-fix-issue-skill-md:
	bash scripts/test-loop-fix-issue-skill-md.sh
