...
- The detection priority literal pattern (`Umbrella tracking issue.` body-primary, `Umbrella:`/`Umbrella —` title-fallback after the #819 bracket-prefix peel) is byte-pinned across fixtures 1-3 and 14-20. Detection-grammar changes (new bracket-block forms, marker variants, cap changes, fail-closed semantics) require coordinated fixture updates.
