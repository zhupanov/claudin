...
(Step 1.1 and 1.2 are sub-steps of Step 1 that execute only when `RESEARCH_SCALE != quick` AND `RESEARCH_PLAN=true`. They are skipped on every other path — single-lane quick mode has no fan-out to assign subquestions to.)
