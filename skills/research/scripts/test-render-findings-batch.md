...
16 cases (numeric IDs match the comment-tagged `# Case N` markers in the harness; cases 13 and 14 land before case 12 in source order due to staged additions, and cases 15 and 16 were added per #745):
