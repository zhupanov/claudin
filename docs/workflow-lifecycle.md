...
- **`/design [--auto] [--quick] [--debug] <feature>`** — Plan a feature without implementing it. Creates a branch, runs collaborative sketches (9 agents in regular mode, 3 in quick mode), writes and reviews the plan with a 3-reviewer panel + voting.
